...
text = re.sub(r'    def _show_setup\(self, defaults: dict \| None = None\):.*?self\._overlay = ov', new_show_setup, text, flags=re.DOTALL)
with open(file_path, 'w', encoding='utf-8') as f:
    f.write(text)
print('Patched _show_setup with try-except')
