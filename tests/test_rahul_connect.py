...
from rahul_connect.gateway.command_router import CommandRouter
from rahul_connect.gateway.device_manager import DeviceManager
from rahul_connect.gateway.capability_manager import CapabilityManager
from rahul_connect.gateway.models import DeviceRecord
from rahul_connect.gateway.pairing import PairingManager
from rahul_connect.gateway.protocol import ProtocolTypes, build_message, validate_message
from rahul_connect.gateway.websocket import ConnectionHub
...
def test_pairing_manager_returns_expiring_offer():
    ...
    assert offer.service == "_RAHUL._tcp.local."
