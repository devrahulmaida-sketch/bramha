...
def should_extract_memory(user_text: str, rahul_text: str, api_key: str = "") -> bool:
    try:
        from or_client import client

        combined = f"User: {user_text[:300]}\nRahul AI: {rahul_text[:1000]}"
...
def extract_memory(user_text: str, rahul_text: str, api_key: str = "") -> dict:
    try:
        from or_client import client

        combined = f"User: {user_text[:600]}\nRahul AI: {rahul_text[:300]}"
        ...
        raw = client.chat(
            ...
            f"                  (e.g. mark_xxv: 'Building a Rahul AI assistant')\n"
            ...
            f"- Extract from BOTH user and Rahul AI turns.\n"
            ...
            f' "projects":{{"mark_xxv":{{"value":"Rahul AI assistant"}}}},\n'
