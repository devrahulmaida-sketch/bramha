package com.rahul.connect.commands
...
class DeviceCommandHandler(private val context: Context) {
    ...
    private fun getDeviceInfo(): CommandResult {
        ...
        return CommandResult(
            ...
            data = mapOf(
                ...
                "capabilities" to RahulConnectCapabilities.INITIAL,
            ),
        )
    }
    ...
    private fun unlockPhone(parameters: Map<String, Any?>): CommandResult {
        ...
        val service = com.rahul.connect.accessibility.RahulAccessibilityService.instance
        if (service == null) {
            return CommandResult(false, errorCode = "ACCESSIBILITY_DISABLED", error = "Rahul Accessibility Service is not enabled.")
        }
